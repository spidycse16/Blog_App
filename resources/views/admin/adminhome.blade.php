...
<html>
  <head> 
    ...
    <link rel="stylesheet" href="adminss/css/font.css">
    <!-- Google fonts - Muli-->
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="/post_page"> <i class="icon-grid"></i>Create Post </a></li>
                <li><a href="/show_post"> <i class="icon-grid"></i>Show Posts </a></li>
